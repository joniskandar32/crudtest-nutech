          ...
          <div class="card-body p-0">
            ...
            <table class="table table-hover table-striped">
              ...
              <tr>
                <td>Harga Beli</td>
                <td>:</td>
                <td><b>Rp <?php echo format_rupiah($product->buy_price); ?></b></td>
              </tr>
              <tr>
                <td>Harga Jual</td>
                <td>:</td>
              ...
              <tr>
                ...
                <td>:</td>
                <td>
                  <img alt="<?php echo $product->name; ?>" class="img img-fluid rounded" src="<?php echo base_url('assets/uploads/products/' . $product->picture_name); ?>" width="200px">
                </td>
              </tr>
            </table>
          </div>
          <div class="card-footer text-right">
            <a href="<?php echo site_url('admin/products/edit/' . $product->id); ?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
            <a href="#" data-toggle="modal" data-target="#deleteModal" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
          </div>
