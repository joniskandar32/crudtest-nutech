...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/slider1.jpeg'); ?>');">
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <p class="breadcrumbs text-danger"><span class="mr-2"><?php echo anchor(base_url(), 'Home'); ?></span> <span>Hubungi Kami</span></p>
        <h1 class="mb-0 bread text-danger">Hubungi Kami</h1>
      </div>
    </div>
  </div>
</div>
...
<section class="ftco-section contact-section bg-light">
  <div class="container">
    <div class="row d-flex mb-5 contact-info">
      ...
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span>Website</span> www.nutech-integrasi.com</p>
        </div>
      </div>
    </div>
    <div class="row block-9">
      ...
      <div class="col-md-6 d-flex">
        <div style="width: 100%">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31727.112834658587!2d106.79447377910152!3d-6.278307799999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f217e9f3902f%3A0xe719fce1e40216ca!2sPT%20Nutech%20Integrasi!5e0!3m2!1sid!2sid!4v1672459712699!5m2!1sid!2sid" width="550" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </div>
  </div>
